...
def refreshList(self, calibrea):
    ...
    '''refresh the seen calibration files'''
...
def plot_update(event, self, canvas, a, ff, max_1, max_2, max_3, max_4, max_5,
                energy_1, energy_2, energy_3, energy_4, energy_5):

    '''reset labels and replot'''
    ...
    a.semilogy(xdata,ydata,"#6B1AD3")
    point, = a.plot([],[], marker="o", color="black")
    toggle_selector.RS = RectangleSelector(a,
                                           lambda eclick,
                                           erelease: on_select(eclick,
                                                               erelease,
                                                               max_1,
                                                               max_2,
                                                               max_3,
                                                               ...
                                                               point),
                                           drawtype='box',
                                           rectprops = dict(facecolor='#C49CF7',
                                                            edgecolor = 'black',
                                                            alpha = 0.2,
                                                            fill = True))
...
def on_select(eclick, erelease, max_1, max_2, max_3, max_4, max_5, a):
    ...
    '''get the max value for the nth peak and put it in the appropriate text
       label'''
...
def add_to_file(self, max_1, max_2, max_3, max_4, max_5, energy_1, energy_2, energy_3, energy_4, energy_5, energy_dict, coefficient):
    ...
    '''based on the calibration spectra input, save the coefficients to a
       text file with a given name, for a given channel'''
